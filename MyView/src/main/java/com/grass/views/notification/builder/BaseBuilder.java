package com.grass.views.notification.builder;
...
import com.grass.views.notification.NotifyUtil;
...
//        cBuilder = new NotificationCompat.Builder(NotifyUtil.context);
        cBuilder = new NotificationCompat.Builder(NotifyUtil.context,NotifyUtil.mChannelId);
//        NotificationCompat.Builder builder = new NotificationCompat.Builder(NotifyUtil.context, null);
        ...
        cBuilder.setChannelId(NotifyUtil.mChannelId);
