package com.grass.views.notification;
...
import com.grass.views.notification.builder.BigPicBuilder;
import com.grass.views.notification.builder.BigTextBuilder;
import com.grass.views.notification.builder.MailboxBuilder;
import com.grass.views.notification.builder.MediaBuilder;
import com.grass.views.notification.builder.ProgressBuilder;
import com.grass.views.notification.builder.SingleLineBuilder;
...
public class NotifyUtil {
    ...
    public static void init(Context context1,String channelId){
        context = context1;
        mChannelId = channelId;
        nm = (NotificationManager) context1.getSystemService(Activity.NOTIFICATION_SERVICE);
        if(Build.VERSION.SDK_INT >=Build.VERSION_CODES.O){
            nm.createNotificationChannelGroup(new NotificationChannelGroup("GrassChannel", "GrassChannel"));
            NotificationChannel channel = new NotificationChannel(channelId, "GrassChannel", NotificationManager.IMPORTANCE_DEFAULT);
