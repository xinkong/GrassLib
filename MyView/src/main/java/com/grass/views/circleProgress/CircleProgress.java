package com.grass.views.circleProgress;
...
import com.grass.views.BuildConfig;
...
public class CircleProgress extends View {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        mIsDrawText = typedArray.getBoolean(R.styleable.CircleProgressBar_isDrawText,true);
        ...
        if (gradientArcColors != 0) {
            ...
            int arcColor = typedArray.getColor(R.styleable.CircleProgressBar_arcColors,  Color.GREEN);
            mGradientColors = new int[2];
